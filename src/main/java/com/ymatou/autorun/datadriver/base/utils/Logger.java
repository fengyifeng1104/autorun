...
public class Logger {
     ...
     */
    public static void createResultFile(String parentFolderName,String folderName,String subFolderName,String suiteName) {
        ...
        /*	FileUtil.createFolderIfNotExist("./Results/" + parentFolderName);
        	FileUtil.createFolderIfNotExist("./Results/" + parentFolderName+"/"+folderName);
        	FileUtil.createFolderIfNotExist("./Results/" + parentFolderName+"/"+folderName + "/"+subFolderName);*/
